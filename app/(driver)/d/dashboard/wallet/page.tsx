...
export default async function DriverWalletPage({}: Props) {
    ...
    <div className='min-h-screen bg-linear-to-b from-blue-50 to-white pb-20'>
      ...
      <div className='max-w-4xl mx-auto px-4 py-6 space-y-6'>
        ...
        <div className='bg-linear-to-r from-blue-500 to-blue-600 rounded-2xl shadow-xl p-6 text-white'>
          ...
          <div className='grid grid-cols-3 gap-4 pt-4 border-t border-white/20'>
            ...
            <div>
              ...
              <p className='text-lg font-semibold'>
                E£{pendingEarnings.toFixed(2)}
              </p>
            </div>
            <div>
              <div className='flex items-center gap-1 mb-1'>
                <TrendingUp className='w-4 h-4' />
                <span className='text-xs opacity-75'>Completed Rides</span>
              </div>
        ...
        <div className='bg-blue-50 border-2 border-blue-200 rounded-2xl p-4'>
          <h3 className='font-bold text-blue-800 mb-2'>How Driver Wallet Works</h3>
          <ul className='text-sm text-blue-700 space-y-1'>
            <li>✓ Earn money from completed app-based rides</li>
            <li>✓ Cash payments are received directly (not shown in balance)</li>
